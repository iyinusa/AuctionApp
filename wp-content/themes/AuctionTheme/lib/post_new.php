...
<div class="clear25"></div>
	...
	<a href="#" <?php if($new_auction_step >= 1): ?> class="active" <?php endif; ?>><?php echo __('Write Auction','AuctionTheme') ?></a>
	<a href="#" <?php if($new_auction_step >= 2): ?> class="active" <?php endif; ?>><?php echo __('Add Photos','AuctionTheme') ?></a>
	<a href="#" <?php if($new_auction_step >= 3): ?> class="active" <?php endif; ?>><?php echo __('Review & Publish','AuctionTheme') ?></a>
        ...
        <p> 
         ...
         <?php	 
			 	...
			 	echo AuctionTheme_get_categories_clck("auction_location",  
                                ...
                                , __('Select Location','AuctionTheme'), "do_input", 'onchange="display_subcat2(this.value)"' );
    	...
    	<div class="my_box3">
                ...
                <div class="box_content">
					...
					<div class="ad-page-image-holder">
						<?php echo AuctionTheme_get_first_post_image($pid, 250, 170, 'img_class'); ?>
                ...
                <div class="bid_panel">
                <div class="padd10">
                <form method="post"> <input type="hidden" name="control_id" value="<?php echo base64_encode($pid); ?>" />
                	<ul class="auction-details">
                    <?php if($only_buy_now == '1'): ?>
                    
							<li>
								<h3><?php echo __("Quantity","AuctionTheme"); ?>:</h3>
								<p><?php echo get_post_meta($pid, 'quant', true); ?> <?php echo __("items"); ?></p>
							</li>
              ...
              <?php 
                ...
                <div class="clear10"></div>
                        ...
                        <li>
						 ...
						 ?>    
                            <li>
								<img src="<?php echo get_template_directory_uri(); ?>/images/price.png" width="20" height="20" /> 
                          ...
                          <?php endif; ?>   
							...
							<li>
								<img src="<?php echo get_template_directory_uri(); ?>/images/location.png" width="20" height="20" /> 
								<h3><?php echo __("Location","AuctionTheme"); ?>:</h3>
								<p><?php echo get_the_term_list( $pid, 'auction_location', '', ', ', '' ); ?></p>
							</li>
                            
                            <li>
								<img src="<?php echo get_template_directory_uri(); ?>/images/category.png" width="20" height="20" /> 
								<h3><?php echo __("Category","AuctionTheme"); ?>:</h3>
								<p><?php echo get_the_term_list( $pid, 'auction_cat', '', ', ', '' ); ?></p>
							</li>
							...
							?>	
							<li>
								<img src="<?php echo get_template_directory_uri(); ?>/images/clock.png" width="20" height="20" /> 
                            ...
                            <li>
								<img src="<?php echo get_template_directory_uri(); ?>/images/watch.png" width="20" height="20" /> 
...
codeAddress("<?php 
 ...
 ?>");
	...
	echo '<div id="right-sidebar" style="width:235px;" class="page-sidebar">';
	echo '<ul class="xoxo">';
	
		$auth = get_userdata($post_au->post_author);
	...
	?>
        ...
        <ul class="other-dets5">
				<li>
					...
					<p><a href="<?php echo AuctionTheme_get_user_profile_link($post_au->post_author);?>"><?php echo $auth->user_login; ?></a></p> 
				</li> 
