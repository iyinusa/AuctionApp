...
add_menu_page(__('Auction Theme'), __('Auction Theme','AuctionTheme'), $capability,"AT_menu_", 'AuctionTheme_site_summary', $icn, 0);
add_submenu_page("AT_menu_", __('Site Summary','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('overview_icon.png').__('Site Summary','AuctionTheme'),$capability, "AT_menu_", 'AuctionTheme_site_summary');
add_submenu_page("AT_menu_", __('General Options','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('setup_icon.png').__('General Options','AuctionTheme'),$capability, "general-options", 'AuctionTheme_general_options');
add_submenu_page("AT_menu_", __('NextBid Levels','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('etiquete.png').__('NextBid Levels','AuctionTheme'),$capability, 'AT_next_bid_', 'AuctionTheme_next_bid_levels');
add_submenu_page("AT_menu_", __('Email Settings','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('email_icon.png').__('Email Settings','AuctionTheme'),$capability, 'AT_email_set_', 'AuctionTheme_email_settings');
add_submenu_page("AT_menu_", __('Pricing Settings','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('dollar_icon.png').__('Pricing Settings','AuctionTheme'),$capability, 'AT_pr_set_', 'AuctionTheme_pricing_options');
add_submenu_page("AT_menu_", __('Custom Pricing','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('penny_icon.png').__('Custom Pricing','AuctionTheme'),$capability, 'AT_cust_pricing_', 'AuctionTheme_cust_pricing');
add_submenu_page("AT_menu_", __('Custom Fields','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('input_icon.png').__('Custom Fields','AuctionTheme'),$capability, 'custom-fields', 'AuctionTheme_custom_fields');
add_submenu_page("AT_menu_", __('Images Options','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('image_icon.png').__('Images Options','AuctionTheme'),$capability, 'AT_img_sett_', 'AuctionTheme_images_settings');
add_submenu_page('AT_menu_', __('Category Images','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('image_icon.png').__('Category Images','PricerrTheme'),$capability, 'AT_cat_img_', 'AuctionTheme_category_images');
add_submenu_page("AT_menu_", __('Payment Gateways','AuctionTheme'),AuctionTheme_disp_spcl_cst_pic('gateway_icon.png'). __('Payment Gateways','AuctionTheme'),$capability, 'AT_pay_gate_', 'AuctionTheme_payment_gateways');
add_submenu_page("AT_menu_", __('Membership Packs','AuctionTheme'),AuctionTheme_disp_spcl_cst_pic('mem_icon.png'). __('Membership Packs','AuctionTheme'),$capability, 'mem-packs', 'auctionTheme_membership_packs');
//add_submenu_page("AT_menu_", __('Discount Coupons','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('cup_icon.png').__('Discount Coupons','AuctionTheme'),$capability, 'AT_discount_', 'AuctionTheme_discount_copuons');
//add_submenu_page("AT_menu_", __('Transactions','AuctionTheme'), __('Transactions','AuctionTheme'),$capability, 'paypal-trans', 'auctionTheme_transactions');
add_submenu_page('AT_menu_', __('Withdrawals','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('wallet_icon.png').__('Withdrawals','AuctionTheme'),$capability, 'Withdrawals', 'AuctionTheme_withdrawals');
add_submenu_page('AT_menu_', __('Escrows','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('vault_icon.png').__('Escrows','AuctionTheme'),$capability, 'Escrows', 'AuctionTheme_escrows');
add_submenu_page('AT_menu_', __('User Balances','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('bal_icon.png').__('User Balances','AuctionTheme'),'10', 'AT_user_bal_', 'AuctionTheme_user_balances');
add_submenu_page('AT_menu_', __('User Reviews','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('review_icon.png').__('User Reviews','AuctionTheme'),'10', 'AT_user_rev_', 'AuctionTheme_user_reviews');
add_submenu_page('AT_menu_', __('Private Messages','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('mess_icon.png').__('Private Messages','AuctionTheme'),'10', 'AT_user_mess_', 'AuctionTheme_user_private_mess');
add_submenu_page("AT_menu_", __('InSite Transactions','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('list_icon.png').__('InSite Transactions','AuctionTheme'),$capability, 'trans-sites', 'auctionTheme_hist_transact');
add_submenu_page("AT_menu_", __('Orders','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('orders_icon.png').__('Orders','AuctionTheme'),$capability, 'AT_orders_', 'AuctionTheme_orders_main_screen');
//add_submenu_page("AT_menu_", __('Disputes','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('arbiter_icon.png').__('Disputes','AuctionTheme'),$capability, 'AT_disp_', 'AuctionTheme_disputes_panel');
add_submenu_page("AT_menu_", __('Layout Settings','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('layout_icon.png').__('Layout Settings','AuctionTheme'),$capability, 'AT_layout_', 'AuctionTheme_layout_settings');
add_submenu_page("AT_menu_", __('Advertising','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('adv_icon.png').__('Advertising','AuctionTheme'),$capability, 'AT_adv_', 'AuctionTheme_advertising_scr');
//add_submenu_page("AT_menu_", __('Import Tools','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('sheet_icon.png').__('Import Tools','AuctionTheme'),$capability, 'AT_import_tls_', 'AuctionTheme_import_tools_panel');
add_submenu_page("AT_menu_", __('Tracking Tools','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('track_icon.png').__('Tracking Tools','AuctionTheme'),$capability, 'AT_trck_', 'AuctionTheme_tracking_tools_panel');
add_submenu_page("AT_menu_", __('Info Stuff','AuctionTheme'), AuctionTheme_disp_spcl_cst_pic('info_icon.png').__('Info Stuff','AuctionTheme'),$capability, 'AT_info_stuff', 'AuctionTheme_info');
			...
			jQuery(function(jQuery) {
				...
				window.send_to_editor = function(html) {
				 ...
				 tb_remove();
                    ...
                    <tr>
                    <td valign=top width="22"><?php AuctionTheme_theme_bullet(__('Eg: http://your-site-url.com/images/logo.jpg','ProjectTheme'),'auction-bull-et-a'); ?></td>
                    ...
                    <a href="#" id="sel_logo" class="button"><?php _e('Upload/Select Logo File','AuctionTheme_logo_URL') ?></a>
...
function AuctionTheme_pricing_options()
{
	...
	$arr_currency = array("USD" => "US Dollars", "EUR" => "Euros", "CAD" => "Canadian Dollars", "CHF" => "Swiss Francs","GBP" => "British Pounds",
						  ...
						  'SEK' => 'Swedish Krona', 'Israeli New Shekel' => 'ILS', 'COP' => 'Colombian Peso', 'THB' => 'Thai Baht' , 'BTC' => 'Bitcoins'
						  );
