...
******************************************************************************/	
			...
			get_header();
                ...
                <div class="box_content">                                          
                        ...
                        <label for="submitbtn">&nbsp;</label>
						  ...
						  <ul id="logins">
							<li><a class="green_btn" href="<?php bloginfo('home'); ?>/" title="<?php _e('Are you lost?','AuctionTheme') ?>"><?php _e('Home','AuctionTheme') ?></a></li>
        ...
        <div class="box_title"><?php _e('Registration Disabled','AuctionTheme') ?></div>
                <div class="box_content">
							...
							<a href="<?php echo get_settings('home'); ?>/" title="<?php _e('Go back to the blog','AuctionTheme') ?>"><?php _e('Home','AuctionTheme') ?></a>
							</p>
						</div></div></div>
		<?php
