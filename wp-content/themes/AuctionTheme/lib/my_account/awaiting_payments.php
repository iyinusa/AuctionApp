...
function AuctionTheme_my_account_awaiting_payment_auctions_area_function()
{
    ...
    <div id="content" class="account-content-area">
		...
		if($my_page > 1)
		echo '<a href="'.AuctionTheme_get_browse__special_pg_link('AuctionTheme_my_account_aw_pay_auctions_id', $previous_pg).'"><< '.__('Previous','ProjectTheme').'</a>';
		...
		echo '<a href="'.AuctionTheme_get_browse__special_pg_link('AuctionTheme_my_account_aw_pay_auctions_id', $next_pg).'">'.__('Next','ProjectTheme').' >></a>';						
