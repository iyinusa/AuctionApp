...
<?php endif; endif; ?>
        ...
        <?php do_action('ActionTheme_after_location_li'); ?>
         ...
         <li><h2><?php echo __('Category', 'AuctionTheme'); ?>:</h2>
			...
			$cat 		  	= wp_get_object_terms($post_au->ID, 'auction_cat');
		 
			
				echo AuctionTheme_get_categories("auction_cat", $cat[0]->term_id , __("Select Category","AuctionTheme"), "do_input"); ?>
            <?php endif; ?>
       ...
       <?php if($only_buy_now == "1"): ?>
        ...
        <textarea rows="6" cols="60" class="do_input"  name="auction_description"><?php 
   ...
   <?php    
        ...
        <li>
        <h2>&nbsp;</h2>
        <p><input type="submit" name="save-auction" value="<?php _e("Save Auction",'AuctionTheme'); ?>" /></p>
        </li>
