              ...
              <table width="100%">
				...
				?>
              			<tr>
                        	...
                        	<td><a href="<?php bloginfo('url') ?>?a_action=buy_memberships&id=<?php echo $row->id ?>" class="green_btn"><?php _e('Purchase Now','AuctionTheme'); ?></a></td>
                        </tr>
		...
		?>
          ...
          <div class="my_box3">
				...
				?>
                    ...
                    <td></td>
                    <td>
                    <input type="submit" name="payme" value="<?php echo __("Make Payment","AuctionTheme"); ?>" /></td></tr></form></table>
