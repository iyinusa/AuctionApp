							...
							{	
								...
								?>
                                	...
                                	<li>	
                                        ...
                                        <p><?php echo $auctiontheme_get_shipping_charge == "0" ? __('FREE','AuctionTheme') : auctiontheme_get_show_price($auctiontheme_get_shipping_charge) ?></p> 
                                    </li> 
	...
	<li class="widget-container widget_text" id="ad-other-details">
		...
		<p>
			<ul class="other-dets5">
				...
				<li>
					<img src="<?php echo get_template_directory_uri(); ?>/images/category.png" width="15" height="15" /> 
